...
export default function Gsap2() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG2 .reverseG2", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG2" ref={containerRef}>
      <div className="next-screenG2" ref={nextScreenRef}>
        <svg className="reverseG2" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG2" ref={headerRef}></div>
      ...
      <div className="screen-1G2">
        <div className="topG2" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG2" ref={buttonRef}>
          <svg className="svg22" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG2" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
