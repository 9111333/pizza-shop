...
export default function Gsap10() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG10 .reverseG10", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG10" ref={containerRef}>
      <div className="next-screenG10" ref={nextScreenRef}>
        <svg className="reverseG10" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG10" ref={headerRef}></div>
      ...
      <div className="screen-1G10">
        <div className="topG10" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG10" ref={buttonRef}>
          <svg className="svg210" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG10" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
