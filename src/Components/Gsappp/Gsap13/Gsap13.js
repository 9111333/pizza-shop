...
export default function Gsap13() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG13 .reverseG13", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG13" ref={containerRef}>
      <div className="next-screenG13" ref={nextScreenRef}>
        <svg className="reverseG13" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG13" ref={headerRef}></div>
      ...
      <div className="screen-1G13">
        <div className="topG13" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG13" ref={buttonRef}>
          <svg className="svg213" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG13" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
