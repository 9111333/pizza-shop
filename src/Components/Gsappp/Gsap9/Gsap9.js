...
export default function Gsap9() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG9 .reverseG9", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG9" ref={containerRef}>
      <div className="next-screenG9" ref={nextScreenRef}>
        <svg className="reverseG9" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG9" ref={headerRef}></div>
      ...
      <div className="screen-1G9">
        <div className="topG9" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG9" ref={buttonRef}>
          <svg className="svg29" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG9" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
