...
export default function Gsap15() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG15 .reverseG15", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG15" ref={containerRef}>
      <div className="next-screenG15" ref={nextScreenRef}>
        <svg className="reverseG15" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG15" ref={headerRef}></div>
      ...
      <div className="screen-1G15">
        <div className="topG15" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG15" ref={buttonRef}>
          <svg className="svg215" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG15" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
