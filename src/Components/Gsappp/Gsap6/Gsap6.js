...
export default function Gsap6() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG6 .reverseG6", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG6" ref={containerRef}>
      <div className="next-screenG6" ref={nextScreenRef}>
        <svg className="reverseG6" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG6" ref={headerRef}></div>
      ...
      <div className="screen-1G6">
        <div className="topG6" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG6" ref={buttonRef}>
          <svg className="svg26" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG6" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
