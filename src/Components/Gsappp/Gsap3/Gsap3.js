...
export default function Gsap3() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG3 .reverseG3", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG3" ref={containerRef}>
      <div className="next-screenG3" ref={nextScreenRef}>
        <svg className="reverseG3" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG3" ref={headerRef}></div>
      ...
      <div className="screen-1G3">
        <div className="topG3" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG3" ref={buttonRef}>
          <svg className="svg23" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG3" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
