...
export default function Gsap7() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG7 .reverseG7", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG7" ref={containerRef}>
      <div className="next-screenG7" ref={nextScreenRef}>
        <svg className="reverseG7" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG7" ref={headerRef}></div>
      ...
      <div className="screen-1G7">
        <div className="topG7" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG7" ref={buttonRef}>
          <svg className="svg27" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG7" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
