...
export default function Gsap11() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG11 .reverseG11", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG11" ref={containerRef}>
      <div className="next-screenG11" ref={nextScreenRef}>
        <svg className="reverseG11" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG11" ref={headerRef}></div>
      ...
      <div className="screen-1G11">
        <div className="topG11" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG11" ref={buttonRef}>
          <svg className="svg211" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG11" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
