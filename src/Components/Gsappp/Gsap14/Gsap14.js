...
export default function Gsap14() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG14 .reverseG14", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG14" ref={containerRef}>
      <div className="next-screenG14" ref={nextScreenRef}>
        <svg className="reverseG14" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG14" ref={headerRef}></div>
      ...
      <div className="screen-1G14">
        <div className="topG14" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG14" ref={buttonRef}>
          <svg className="svg214" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG14" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
