...
export default function Gsap8() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG8 .reverseG8", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG8" ref={containerRef}>
      <div className="next-screenG8" ref={nextScreenRef}>
        <svg className="reverseG8" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG8" ref={headerRef}></div>
      ...
      <div className="screen-1G8">
        <div className="topG8" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG8" ref={buttonRef}>
          <svg className="svg28" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG8" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
