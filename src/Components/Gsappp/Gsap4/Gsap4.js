...
export default function Gsap4() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG4 .reverseG4", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG4" ref={containerRef}>
      <div className="next-screenG4" ref={nextScreenRef}>
        <svg className="reverseG4" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG4" ref={headerRef}></div>
      ...
      <div className="screen-1G4">
        <div className="topG4" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG4" ref={buttonRef}>
          <svg className="svg24" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG4" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
