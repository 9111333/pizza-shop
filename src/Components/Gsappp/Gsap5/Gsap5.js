...
export default function Gsap5() {
  ...
  useEffect(() => {
    if (
      ...
      tl.from(".next-screenG5 .reverseG5", {
        ease: "power1.inOut",
        xPercent: -250,
        duration: 0.5,
      });
  ...
  return (
    <div className="containerG5" ref={containerRef}>
      <div className="next-screenG5" ref={nextScreenRef}>
        <svg className="reverseG5" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG5" ref={headerRef}></div>
      ...
      <div className="screen-1G5">
        <div className="topG5" ref={topRef}>
          <h1 ref={h1Ref}>No.1</h1>
        </div>

        <div className="buttonG5" ref={buttonRef}>
          <svg className="svg25" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG5" ref={loadingRef}>
          اطلاعات بیشتر ...
        </div>
      </div>
    </div>
