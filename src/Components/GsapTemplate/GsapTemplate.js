...
import "./GsapTemplate.css";

export default function GsapTemplate() {
  ...
  return (
    <div className="containerG" ref={containerRef}>
      <div className="next-screenG" ref={nextScreenRef}>
        <svg className="reverseG" viewBox="0 0 24 24" ref={reverseRef}>
          <g>
            <g>
        ...
        <div className="headerG" ref={headerRef}></div>
      ...
      <div className="screen-1G">
        <div className="topG" ref={topRef}>
          <h1 ref={h1Ref}>photography</h1>
        </div>

        <div className="buttonG" ref={buttonRef}>
          <svg className="svg2" viewBox="0 0 24 24">
            <g>
              <g>
        ...
        <div className="loadingG" ref={loadingRef}>
          fetching article ...
        </div>
      </div>
    </div>
